<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="directorate.aspx.cs" Inherits="directorate" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    ...
    <div class="form-group row">
                    ...
                    <div class="col-sm-6 col-md-5">
                          <div class="form-group">
                             <asp:TextBox id="Txt_Country" CssClass="input-text full-width" runat="server" ValidationGroup="Enquiry" placeholder="Search By College Country"></asp:TextBox>
                         </div>
                     </div>

                    <div class="col-sm-6 col-md-5">
                          <div class="form-group">
                             <asp:TextBox id="Txt_City" CssClass="input-text full-width" runat="server" ValidationGroup="Enquiry" placeholder="Search By College City"></asp:TextBox>
                         </div>
                     </div>
    ...
    <asp:GridView ID="Directorate_Grid" Width="100%" AutoGenerateColumns="false" runat="server">
                    <Columns>
                        ...
                        <asp:TemplateField  HeaderText="College Country"> 
                             <ItemTemplate>
                                 <asp:Label ID="Lbl_College_Country" runat="server" CssClass="grid_label" Text='<%# Eval("country") %>'></asp:Label>
                             </ItemTemplate>
                         </asp:TemplateField>

                        <asp:TemplateField  HeaderText="College City"> 
                             <ItemTemplate>
                                 <asp:Label ID="Lbl_College_City" runat="server" CssClass="grid_label" Text='<%# Eval("city") %>'></asp:Label>
                             </ItemTemplate>
                         </asp:TemplateField>
