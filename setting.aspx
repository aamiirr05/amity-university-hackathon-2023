    ...
    <section id="setting">
        ...
        <div class="up-email">
            ...
            <div class="con-mail">
                ...
                <asp:Button ID="Btn_Submit_Email" CssClass="inp sub" OnClick="Btn_Submit_Email_Click" runat="server" Text="Update Email" />
                <asp:ValidationSummary ID="ValidationSummary2" ValidationGroup="email" ShowSummary="false" runat="server" />
            </div>
        </div>
