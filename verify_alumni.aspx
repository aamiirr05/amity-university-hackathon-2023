<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="verify_alumni.aspx.cs" Inherits="verify_alumni" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    ...
    <asp:GridView ID="Grid_Personal" CssClass="grid_view" AutoGenerateColumns="false" runat="server">
                    <Columns>
                        ...
                        <asp:HyperLinkField HeaderText="Checked" ControlStyle-ForeColor="#11936e" Text="Checked" HeaderStyle-Width="100" ItemStyle-Width="100"  DataNavigateUrlFields="alumni_id" DataNavigateUrlFormatString="verify_alumni.aspx?id={0}" /> 
                    </Columns>
                </asp:GridView>
        </div>
    <br />
